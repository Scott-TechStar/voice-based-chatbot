#install all of the required modules using pip
#pip install pyttsx3
...
#Create lists with your preset questions answers
greetings = ['hey there','heey', 'hello', 'hi', 'Hai', 'hey!', 'hey']
...
#Calibrate the speech recognition engine
while True:
...
if r.recognize_google(audio) in greetings:
       ...
       engine.say('I`m Scott your personal assistant')
       engine.runAndWait()
